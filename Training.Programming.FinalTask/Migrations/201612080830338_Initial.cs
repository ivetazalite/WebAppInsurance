namespace Training.Programming.FinalTask.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ClientSsn = c.String(),
                        ClientSex = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        PolicyState = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Policies", "Product_ProductId", "dbo.Products");
            DropForeignKey("dbo.Policies", "Client_ClientId", "dbo.Clients");
            ...
            DropIndex("dbo.Policies", new[] { "Product_ProductId" });
            DropIndex("dbo.Policies", new[] { "Client_ClientId" });
